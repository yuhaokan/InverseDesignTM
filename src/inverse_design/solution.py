...
def train(env_name, algo_name):
    ...
    eval_callback = EvalCallback(
        env, 
        eval_freq=5, # how often to perform evaluation i.e. every 10000 timesteps.
    ...
    """
    model.learn(total_timesteps=int(1e3), tb_log_name=f"{env_name}_{algo_name}", callback=eval_callback)
